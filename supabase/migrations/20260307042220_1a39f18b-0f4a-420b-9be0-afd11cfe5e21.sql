...
AS $$
  -- Flat stable pseudo-random order using md5 hash of id.
  -- No window functions, no partitioning — just a consistent shuffle
  -- so every page of 20 is naturally diverse across all dealers.
  SELECT
